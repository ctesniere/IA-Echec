...
public class AlphaBeta extends Algorithm {
	 ...
	 */
	private ChessboardValue alphaBetaAlg(ChessboardValue _chessValue,
			ChessboardValue _alpha, ChessboardValue _beta, boolean _color,
			int _counter) {
		...
		ArrayList<Move> allPossibleMove = _chessValue.getActualChessboard()
				.generateAllPossibleMoves(_color);
